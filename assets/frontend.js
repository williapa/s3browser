$(function(){
  ...
  /* getting data generated by node */
 ...
 function updateHTML(currentFiles, currentFolders, files, folders, data, column){
  ...
  currentFolders.forEach(function(item){
    ...
    $("#"+item).click(function(){
      ...
      currentRow = (data[this.id].Key.split("/").length);
      $("#"+this.id).children(":first").toggleClass("selected");
      $("#column"+currentRow+" .data").empty();
